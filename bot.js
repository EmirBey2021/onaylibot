...
setInterval(() => {
let değerler =["v!yardım | v!botbilgi",  `${client.guilds.cache.size} Sunucu ve ${client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString()} Kullanıcıya Hizmet Veriyorum!`];
...
<a:developer_2:803897479358709781> **Selamlar, Ben Forsythe (Vexien'in Geliştiricisi) Botumuzu Eklediğiniz ve Bize Destek Olduğunuz İçin Teşekkürler.**

**Vexien Botun Prefixi(ön eki) = v!**

\`Nasıl Kullanılır?\`
**Vexien Botun Tüm Özelliklerinden Yararlanabilmek İçin Sadece v!yardım Yazmanız Yeterlidir.**
...
.addField("Sunucudaki Kişi Sayısı:", guild.memberCount)
   ...
   client.channels.cache.get('805011491584606228').send(plasmicc);
